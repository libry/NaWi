...
public class Inhaltselement_Tiere extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.parent) {
            Intent i = new Intent(Inhaltselement_Tiere.this, Inhaltsuebersicht_Tiere.class);
            i.putExtra("thisElement", this.parentName);
            i.putExtra("elements", this.elements);
            i.putExtra("category", this.category);
            startActivity(i);
        } else if (id == R.id.prev) {
            Intent i = new Intent(Inhaltselement_Tiere.this, Inhaltselement_Tiere.class);
            if(this.position > 0) {
            ...
            Intent i = new Intent(Inhaltselement_Tiere.this, Hauptfenster.class);
            startActivity(i);
        }
